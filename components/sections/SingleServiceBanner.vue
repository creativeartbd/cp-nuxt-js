...
.top-quality-services h2,
p {
    color: #292f34;
}

.top-quality-services .free-trial,
.get-started {
...
.top-quality-services .get-started {
    margin-right: 10px;
    color: #fff;
    background-color: #00364b;
}

.top-quality-services .button-group {
    margin-top: 30px;
    display: flex;
}
...
/* Responsive Styles - Bootstrap 5.3.3 Compatible */
